...
public class SearchMoviePersonResultDto implements org.apache.thrift.TBase<SearchMoviePersonResultDto, SearchMoviePersonResultDto._Fields>, java.io.Serializable, Cloneable, Comparable<SearchMoviePersonResultDto> {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case HAS_MORE:
      if (value == null) {
        ...
        setHasMore((java.lang.Integer)value);
      }
      break;
  ...
  public int compareTo(SearchMoviePersonResultDto other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetMoviePersonDataDtoList()).compareTo(other.isSetMoviePersonDataDtoList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMoviePersonDataDtoList()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("SearchMoviePersonResultDto(");
    boolean first = true;
