...
public class MoviePersonStatDataVo implements org.apache.thrift.TBase<MoviePersonStatDataVo, MoviePersonStatDataVo._Fields>, java.io.Serializable, Cloneable, Comparable<MoviePersonStatDataVo> {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case GAIN_AWARD_NUM:
      if (value == null) {
        ...
        setGainAwardNum((java.lang.Integer)value);
      }
      break;
    ...
    case NOMINATION_AWARD_NUM:
      if (value == null) {
        ...
        setNominationAwardNum((java.lang.Integer)value);
      }
      break;
    ...
    case JOIN_MOVIE_NUM:
      if (value == null) {
        ...
        setJoinMovieNum((java.lang.Integer)value);
      }
      break;
  ...
  public int compareTo(MoviePersonStatDataVo other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetGainAwardNum()).compareTo(other.isSetGainAwardNum());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetNominationAwardNum()).compareTo(other.isSetNominationAwardNum());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNominationAwardNum()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetJoinMovieNum()).compareTo(other.isSetJoinMovieNum());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetJoinMovieNum()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("MoviePersonStatDataVo(");
    boolean first = true;
