...
public class SleepAnalysisResultBeanDto extends BaseAnalysisResultBean {
    ...
    public boolean equals(Object o) {
        if (this == o) {
            return true;
        } else if (!(o instanceof BaseAnalysisResultBean)) {
            return false;
        } else {
            BaseAnalysisResultBean resultDto = (BaseAnalysisResultBean)o;
