...
public class ClassLoaderTest {
    ...
    public static void compare() throws Exception {
        ...
        Object obj = myLoader.loadClass("com.jvm.classloader.TestGit").newInstance();
        System.out.println("obj.getClass().getClassLoader() = " + obj.getClass().getClassLoader());

        com.jvm.classloader.TestGit myloadObj = (TestGit)obj;
        System.out.println("myloadObj.getClass().getClassLoader() = " + myloadObj.getClass().getClassLoader());

        com.jvm.classloader.TestGit testObj = new com.jvm.classloader.TestGit();
        ...
        boolean is = obj instanceof  com.jvm.classloader.TestGit;
    ...
    public static void reflectInvokeTest() throws Exception{
        Class myclass = myLoader.loadClass("com.jvm.classloader.ClassLoaderTest");
