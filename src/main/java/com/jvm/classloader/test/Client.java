package com.jvm.classloader.test;

import com.jvm.classloader.myloader.MyClassLoaderNotOverride;
...
public class Client {
    public static void main(String[] args)  throws Exception{
        ...
        try {
            //加载class文件
            cls1 = diskLoader1.loadClass("com.jvm.classloader.test.SpeakTest");
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Class c = cl.loadClass("com.jvm.classloader.test.SpeakTest");
